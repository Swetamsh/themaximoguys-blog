...
tldr: "Maximo admins don't lose their jobs with MAS 9 -- the role transforms from infrastructure owner to platform operator. Kubernetes knowledge is practical, not theoretical, and your deep Maximo expertise combined with cloud skills makes you uniquely valuable."
seoTitle: "WebSphere to Platform Engineer: MAS 9 Admin Guide"
seoDescription: "Guide for Maximo admins evolving from WebSphere to MAS 9 platform operations. Learn Kubernetes, observability, and the shared responsibility model."
targetQuestions:
  - "Will my Maximo admin job disappear if IBM manages MAS infrastructure?"
  - "How much Kubernetes do Maximo administrators need to learn?"
  - "What does a MAS 9 administrator do day to day?"
  - "How do I troubleshoot MAS 9 on OpenShift?"
  - "Should Maximo admins get Kubernetes certification?"
semanticKeywords:
  - "Maximo administrator MAS 9 transition"
  - "WebSphere to Kubernetes migration"
  - "MAS 9 platform operations"
  - "OpenShift Maximo administration"
  - "Kubernetes Maximo troubleshooting"
  - "shared responsibility model MAS"
  - "Prometheus Grafana Maximo monitoring"
  - "Maximo cloud operations"
  - "platform engineering Maximo"
  - "MAS operator management"
  - "Maximo admin career path"
proficiencyLevel: "intermediate"
dependencies:
  - "Experience administering Maximo 7.6 on WebSphere"
  - "Familiarity with database administration (DB2, Oracle, or SQL Server)"
  - "Basic understanding of networking and security concepts"
  - "Completion of Part 1: Developer Mindset Shift Overview"
speakableSections:
  - "TL;DR"
  - "Key Takeaways"
...
*This is Part 4 of the "Developer Mindset Shift" series. Previous: [Beyond MIF: The Event-Driven Awakening](#) | Start: [The Maximo Developer's Transition](#)*
