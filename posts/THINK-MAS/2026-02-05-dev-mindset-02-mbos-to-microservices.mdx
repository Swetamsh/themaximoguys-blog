...
tldr: "Automation scripts largely survive migration to MAS 9, but custom MBOs need case-by-case evaluation. GraphQL replaces direct SQL as the primary data access method, and React replaces Dojo for UI development."
seoTitle: "From MBOs to Microservices: Maximo MAS 9 Dev Guide"
seoDescription: "Practical guide for Maximo app developers migrating from 7.6 MBOs and automation scripts to MAS 9. Learn GraphQL, React UI, and extensibility patterns."
targetQuestions:
  - "Do my Maximo automation scripts work in MAS 9?"
  - "What happens to custom MBOs when migrating to MAS?"
  - "How do I use GraphQL in IBM Maximo MAS 9?"
  - "Do I need to learn React for MAS 9 UI development?"
  - "How do I migrate Maximo custom code to MAS 9?"
semanticKeywords:
  - "Maximo MBO migration"
  - "MAS 9 automation scripts"
  - "Maximo GraphQL API"
  - "Maximo React UI framework"
  - "Maximo customization migration"
  - "Jython to Python Maximo"
  - "MAS extensibility patterns"
  - "Maximo application development"
  - "custom MBO evaluation"
  - "Maximo code modernization"
  - "Dojo to React migration"
proficiencyLevel: "advanced"
dependencies:
  - "Experience writing Maximo automation scripts (Python/Jython)"
  - "Familiarity with Maximo MBO architecture and Java customizations"
...
*This is Part 2 of the "Developer Mindset Shift" series. Previous: [The Maximo Developer's Transition](#) | Next: [Beyond MIF: The Event-Driven Awakening](#)*
