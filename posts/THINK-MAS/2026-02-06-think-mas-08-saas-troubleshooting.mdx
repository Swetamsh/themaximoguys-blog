...
tldr: "In MAS SaaS you cannot SSH into servers -- use the three-layer control model to classify issues, collect evidence strategically, and escalate to IBM Support with structured cases that resolve in hours, not days."
seoTitle: "MAS SaaS Troubleshooting | No SSH, No Problem"
seoDescription: "Complete guide to troubleshooting MAS SaaS without backend access. Master the three-layer control model, evidence collection, and IBM Support escalation."
targetQuestions:
  - "How do I troubleshoot MAS SaaS without SSH or database access?"
  - "How do I write an effective IBM Support case for MAS?"
  - "What proactive monitoring should I set up for MAS SaaS?"
  - "What is the three-layer control model for MAS troubleshooting?"
  - "How do I classify MAS issues in the first 5 minutes?"
semanticKeywords:
  - "MAS SaaS troubleshooting"
  - "IBM Support case management"
  - "MAS observability"
  - "three-layer control model"
  - "proactive monitoring Maximo"
  - "SaaS operations"
...
dependencies:
  - "Experience with Maximo administration (7.6 or MAS)"
  - "Understanding of MAS SaaS deployment model"
...
## Introduction: The 3:17 AM SaaS Support Call

*Note: The scenario in this post is an anonymized composite based on common SaaS support patterns we've seen in MAS environments.*
...
- Limited visibility compared with the old on-prem model
...
**Previous:** [Part 7 - Modern Mobile: A Stronger Model for Field Operations](/posts/THINK-MAS/modern-mobile-maximo)
