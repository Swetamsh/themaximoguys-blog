...
coverImage: "./images/think-mas-part-2.png"
...
tldr: "MAS 9 replaces the monolithic WebSphere architecture with containerized microservices on OpenShift, managed by Kubernetes operators that automate deployment, scaling, and healing."
seoTitle: "MAS 9 Architecture | Microservices, OpenShift & Operators"
seoDescription: "Technical deep dive into MAS 9 architecture: OpenShift, containers, Kubernetes operators, and microservices. Essential for Maximo architects planning migration."
targetQuestions:
  - "What is the difference between Maximo 7.6 and MAS 9 architecture?"
  - "Does MAS 9 require Red Hat OpenShift?"
  - "How do Kubernetes operators work in MAS 9?"
  - "How long does it take to deploy MAS 9 compared to Maximo 7.6?"
  - "Should I choose MAS SaaS or on-premises?"
semanticKeywords:
  - "MAS 9 architecture"
  - "OpenShift Maximo"
  - "Kubernetes operators"
  - "containerized microservices"
  - "Maximo horizontal scaling"
  - "MAS deployment model"
  - "Red Hat OpenShift EAM"
  - "MAS operator lifecycle"
  - "cloud-native asset management"
  - "MAS SaaS vs on-premises"
proficiencyLevel: "advanced"
dependencies:
  - "Understanding of Maximo 7.6 architecture (WebSphere, EAR deployment)"
  - "Basic knowledge of containers and Kubernetes concepts"
  - "Familiarity with cloud infrastructure models (IaaS, PaaS, SaaS)"
speakableSections:
