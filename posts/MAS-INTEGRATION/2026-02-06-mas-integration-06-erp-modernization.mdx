...
series:
  ...
  part: 6
  total: 8
tldr: "Migrating legacy Maximo-to-ERP integrations from MEA, direct database links, and MIF enterprise services to modern API-mediated patterns. Includes specific playbooks for SAP S/4HANA OData, Oracle EBS ORDS, and Oracle Cloud OIC integrations with MAS, plus phased migration strategies."
seoTitle: "MAS ERP Integration | SAP & Oracle Migration Guide"
seoDescription: "Migrate Maximo-to-ERP integrations from MIF to modern APIs. Playbooks for SAP S/4HANA OData, Oracle EBS ORDS, and Oracle Cloud with phased migration strategies."
targetQuestions:
  - "How do I migrate MIF ERP integrations to MAS?"
  - "Can MAS integrate directly with SAP S/4HANA?"
  - "How do I connect MAS to Oracle EBS or Oracle Cloud?"
  - "Does IBM still support the Maximo Enterprise Adapter?"
  - "How do I move from batch ERP sync to real-time integration?"
semanticKeywords:
...
dependencies:
  - "Understanding of MIF enterprise services (Part 1)"
  - "Familiarity with ERP systems (SAP or Oracle)"
  - "Knowledge of MAS REST APIs (Part 4)"
  - "Enterprise integration patterns (Part 5)"
speakableSections:
  - "The Legacy ERP Integration Landscape"
  - "SAP S/4HANA Integration Playbook"
