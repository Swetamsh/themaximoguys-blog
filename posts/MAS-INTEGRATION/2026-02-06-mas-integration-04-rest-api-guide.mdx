...
series:
  ...
  part: 4
  total: 8
tldr: "A hands-on practitioner's reference to the MAS REST API covering authentication, CRUD operations, complex queries with oslc.where, pagination, bulk operations, action invocations, attachments, and error handling -- with working code examples in curl, Python, and Node.js."
seoTitle: "MAS REST API Guide | CRUD, Queries & Code Examples"
seoDescription: "Hands-on MAS REST API guide: authentication, CRUD operations, complex queries, bulk ops, attachments, and error handling with curl, Python, and Node.js code examples."
targetQuestions:
  - "How do I authenticate against the MAS REST API?"
  - "What is the base URL for MAS REST APIs?"
  - "How do I query work orders using oslc.where in MAS?"
  - "How do I handle pagination in MAS REST API?"
  - "Can I create related records in a single MAS API call?"
semanticKeywords:
  - "MAS REST API"
  - "OSLC API"
  - "oslc.where query"
...
dependencies:
  ...
  - "MAS API-first architecture concepts (Part 2)"
  - "Access to a MAS environment for testing"
speakableSections:
  - "Authentication Deep Dive"
  - "CRUD Operations Reference"
  - "Complex Queries with oslc.where"
