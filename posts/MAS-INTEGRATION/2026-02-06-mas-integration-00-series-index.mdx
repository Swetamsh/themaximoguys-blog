...
series:
  ...
  part: 0
  total: 8
tldr: "The complete 8-part guide to modernizing Maximo integration from legacy MIF to cloud-native REST APIs, Kafka event streaming, and App Connect middleware -- written by practitioners who have migrated real production environments."
seoTitle: "MAS Integration Series | MIF to REST API Migration"
seoDescription: "Complete 8-part guide to modernizing IBM Maximo integration. Covers MIF migration, REST APIs, Kafka events, App Connect, ERP sync, IoT, and security governance."
targetQuestions:
  - "How do I migrate from MIF to modern MAS integration?"
  - "What is the best way to integrate with IBM Maximo MAS?"
  - "Does MAS 9 still use the Maximo Integration Framework?"
  - "What replaced publish channels and enterprise services in MAS?"
  - "How do I connect MAS to SAP or Oracle ERP?"
semanticKeywords:
  ...
  - "Maximo MAS modernization"
proficiencyLevel: "intermediate"
dependencies:
  - "Basic understanding of IBM Maximo or MAS"
  - "Familiarity with enterprise integration concepts"
  - "General knowledge of REST APIs and JSON"
speakableSections:
