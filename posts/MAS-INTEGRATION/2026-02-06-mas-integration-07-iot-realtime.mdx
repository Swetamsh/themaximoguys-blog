...
keyTakeaways:
  ...
  - "IoT integration requires thinking in data streams, not transactions — a fundamental paradigm shift for Maximo developers"
...
series:
  ...
  part: 7
  total: 8
tldr: "How MAS connects physical assets to digital systems through Maximo Monitor, MQTT protocols, IoT sensor data streams, real-time anomaly detection, and condition-based maintenance triggers. Covers the Monitor-to-Manage pipeline, edge computing, and IoT gateway architecture."
seoTitle: "MAS IoT Integration | Monitor, MQTT & Sensor Data"
seoDescription: "Connect physical assets to MAS with Maximo Monitor, MQTT, IoT sensors, anomaly detection, and condition-based maintenance. Covers the Monitor-to-Manage pipeline and edge computing."
targetQuestions:
  - "How does Maximo Monitor integrate with IoT sensors?"
  - "What IoT protocols does MAS support?"
  - "Can MAS automatically create work orders from sensor alerts?"
  - "What is the difference between Maximo Monitor and Maximo Manage?"
  - "How do I connect MQTT sensors to MAS Monitor?"
semanticKeywords:
  - "Maximo Monitor"
  - "MQTT protocol"
  ...
  - "Monitor-to-Manage pipeline"
  - "real-time asset monitoring"
proficiencyLevel: "advanced"
dependencies:
  - "Understanding of MAS application suite architecture"
  - "Basic knowledge of IoT concepts and sensor data"
  - "Familiarity with MQTT or publish-subscribe messaging"
speakableSections:
