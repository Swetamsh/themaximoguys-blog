...
- Red Hat OpenShift Container Platform 4.10+ (use **OCP 4.16-4.21** if you plan to join the MAS 9.2 continuous-delivery Feature Channel stream)
- IBM Cloud Pak for Data 4.6+ (the MAS 9.2 stream targets **Cloud Pak for Data 5.2.0**)
- MongoDB 7.0 or 8.0 (Community or Enterprise) for the 9.2 stream
