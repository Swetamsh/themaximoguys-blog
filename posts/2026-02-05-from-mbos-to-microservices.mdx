...
```
┌─────────────────────────────────────────────────────────────┐
│              CUSTOM MBO MIGRATION DECISION                   │
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  Does it compile against MAS Manage APIs?                   │
│  ├─ NO → Identify deprecated APIs, find alternatives        │
│  └─ YES ↓                                                   │
│                                                              │
│  Does it have external dependencies?                        │
│  ├─ YES → Verify network/cluster accessibility              │
│  └─ NO ↓                                                    │
│                                                              │
│  Is the logic complex enough to warrant Java?               │
│  ├─ NO → Consider refactoring to automation script          │
│  └─ YES ↓                                                   │
│                                                              │
│  Could this be an external microservice?                    │
│  ├─ YES → Consider API-based architecture                   │
│  └─ NO → Migrate and test extensively                       │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
...
```
7.6: UI ↔ Java Beans ↔ MBOs ↔ Database

MAS: UI (React) ↔ GraphQL API ↔ Manage Backend
           ↓
    External Services
```
