...
faqs:
  ...
  - question: "Does this series cover MAS 9.x?"
    answer: "Yes. The series covers MAS Health fundamentals that apply across versions, and includes MAS 9.x-specific content such as the Scoring Groups architecture, the four asset views (Table, Map, Charts, Matrix), pre-configured Work Queues, DGA widgets for transformer health, and the Condition Monitoring integration for IoT-connected meters."
