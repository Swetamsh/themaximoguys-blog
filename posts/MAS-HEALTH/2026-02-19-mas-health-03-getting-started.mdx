...
> **Platform stack note (MAS 9.2 stream):** The MAS 9.2 continuous-delivery stream supports OpenShift 4.16–4.21, MongoDB 7.0 and 8.0 (Community or Enterprise), and Cloud Pak for Data 5.2. Standard support and software updates for MAS 8.10 and 8.11 end **April 30, 2026** -- factor that into your platform planning if you are still on 8.x.
