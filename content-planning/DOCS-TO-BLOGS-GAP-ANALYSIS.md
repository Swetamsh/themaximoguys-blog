...
| DOC8 | Storekeeper Quick Wins | 🟡 **CONTENT COMPLETE, ASSETS BLOCKED** | `posts/MAS-SUPPLY-CHAIN` (merged playbook) | Rotate the leaked nanobanana API key (confirmed still `403 PERMISSION_DENIED` 2026-07-20, `covers-supply-chain-a` job), then generate 11 covers |
| DOC9 | Purchasing Quick Wins | 🟡 **CONTENT COMPLETE, ASSETS BLOCKED** | `posts/MAS-SUPPLY-CHAIN` (merged playbook) | Rotate the leaked nanobanana API key (confirmed still `403 PERMISSION_DENIED` 2026-07-20, `covers-supply-chain-a` job), then generate 11 covers |
| DOC10 | Purchasing Lifecycle Flow | 🟡 **CONTENT COMPLETE, ASSETS BLOCKED** | `posts/MAS-SUPPLY-CHAIN` (merged playbook) | Rotate the leaked nanobanana API key (confirmed still `403 PERMISSION_DENIED` 2026-07-20, `covers-supply-chain-a` job), then generate 11 covers |
